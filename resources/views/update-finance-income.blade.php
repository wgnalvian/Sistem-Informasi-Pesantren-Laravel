    ...
    <div class="container-md ">
        <div class="row pemasukan-container px-5 py-2">
            <div class="col bg-white border-top border-3 border-info px-4 py-4 shadow">
                <form method="POST" action="/finance/income-update/{{$data->finance_id}}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="sumber_pemasukan" value="{{$data->finance_source}}" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="floatingTextarea" name="deskripsi_pemasukan" >{{$data->finance_description}}</textarea>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" step="any" class="form-control" name="jumlah_pemasukan" value="{{$data->amount_income}}"/>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_pemasukan" value="{{$data->finance_date}}"/>
                    </div>
