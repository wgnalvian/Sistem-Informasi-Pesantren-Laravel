    ...
    <div class="container-md ">
        <div class="row pengeluaran-container px-5 py-2">
            <div class="col bg-white border-top border-3 border-info px-4 py-4 shadow">
                <form method="POST" action="{{ route('handleInputExpenditure') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="sumber_pengeluaran" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="floatingTextarea" name="deskripsi_pengeluaran"></textarea>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" step="any" class="form-control" name="jumlah_pengeluaran" />
