                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <select name="tahun" id="" class="form-select ">
                                <option selected value="{{$tahun}}">{{$tahun ?? '...Tahun'}}</option>
                                ...
                                <tr>
                                    @if ($item->finance_category == 'pemasukan')
                                        ...
                                        <td class="text-center"><a
                                                href="/finance/update/{{ $item->finance_id }}"><button
                                                    class="btn btn-sm  text-dark rounded-3"
                                                    style="background-color : #F5FF07">edit</button></a>

                                            <form action="/finance/delete/{{ $item->finance_id }}" method="POST">
                                                @csrf
                                                <button class="btn btn-sm text-whtie rounded-3"
                                    ...
                                    @if ($item->finance_category == 'pengeluaran')
                                        ...
                                        <td class="text-center"><a href="/finance/update/{{ $item->finance_id }}">
                                                <button class="btn btn-sm  text-dark rounded-3"
                                                    style="background-color : #F5FF07">edit</button>
            ...
            <div
                ...
                <form action="/finance/pdf" method="POST">
                    ...
                    <button type="submit" class="btn btn-lg text-white fw-bold rounded-3"
                        style="background-color : #6E00FF">Cetak</button>
                </form>
            </div>
        </div>
